@extends('layouts.app')
@section('title', 'الأسئلة الشائعة - Media Bridge')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="accordion" id="faqAccordion">
                @php
                    $faqs = [
                        ['q' => 'ما هي Media Bridge؟', 'a' => 'Media Bridge منصة رقمية وسيطة تربط الشركات والعلامات التجارية بوكالات التسويق الرقمي. تتيح للشركات نشر حملاتها الإعلانية واستقبال عروض تنافسية من الوكالات المتخصصة.'],
